...
- **Customized Consensus & Halving:** Rincoin features a tailored halving schedule (every 210,000 blocks / ~145 days). The consensus rules, including custom base58 address prefixes (prefix `60`), have been strictly validated against a completely modernized test suite.
...
| **Block Reward** | 50 RIN (initial coinbase reward) |
| **Halving Schedule** | Every 210,000 blocks (~145 days at 1 min blocks) |
